...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment3-group-7/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dsi_with_srl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dsi_with_srl.tcl -notrace
