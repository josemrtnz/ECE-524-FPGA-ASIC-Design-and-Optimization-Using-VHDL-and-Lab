...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment2-group-7/lab_assignment2_group7/lab_assignment2_group7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cic.tcl -notrace
