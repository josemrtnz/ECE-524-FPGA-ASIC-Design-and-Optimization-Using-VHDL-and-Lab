...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment5-group-7/assignment1/assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_A1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_A1.tcl
