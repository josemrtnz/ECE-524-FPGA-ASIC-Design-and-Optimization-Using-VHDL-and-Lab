...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment3-group-7/Lab3/Lab3.runs/c_shift_ram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_shift_ram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_shift_ram_0.tcl
