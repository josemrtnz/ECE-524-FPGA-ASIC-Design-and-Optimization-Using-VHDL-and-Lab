...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment4-group-7/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_50.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_50.tcl
