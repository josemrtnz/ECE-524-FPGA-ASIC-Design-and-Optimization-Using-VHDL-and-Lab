...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment5-group-7/assignment1/assignment1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_A1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_A1.tcl -notrace
