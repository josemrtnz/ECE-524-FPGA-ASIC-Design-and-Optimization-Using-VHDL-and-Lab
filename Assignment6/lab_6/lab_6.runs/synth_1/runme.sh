...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment6-group-7/lab_6/lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lvl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lvl.tcl
