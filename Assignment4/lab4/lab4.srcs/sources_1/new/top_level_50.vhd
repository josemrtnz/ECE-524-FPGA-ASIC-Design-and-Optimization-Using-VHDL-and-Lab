...
entity top_level_50 is
    Port ( clk, rst: in std_logic;
           avg: out std_logic_vector(7 downto 0));
end top_level_50;

architecture Behavioral of top_level_50 is

    component data_path_2 is
...
begin
    ...
    data_path_1: data_path_2 port map (clk => clk, rst => rst, i_clr => i_clr, i_ld => i_ld, a_clr => a_clr,
                          a_ld => a_ld, sum_clr => sum_clr, sum_ld => sum_ld, avg_clr => avg_clr, 
                          avg_ld => avg_ld, avg => avg, i_lt50 => i_lt32);
