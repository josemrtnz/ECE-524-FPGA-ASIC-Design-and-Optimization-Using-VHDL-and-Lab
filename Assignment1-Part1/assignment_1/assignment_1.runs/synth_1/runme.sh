...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment1-part1-group-7/assignment_1/assignment_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_unit.tcl
