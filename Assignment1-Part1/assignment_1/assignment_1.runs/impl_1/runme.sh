...
HD_PWD='/home/josemrtnz/Documents/ECE524L/fa21-e524-lab-assignment1-part1-group-7/assignment_1/assignment_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_unit.tcl -notrace
