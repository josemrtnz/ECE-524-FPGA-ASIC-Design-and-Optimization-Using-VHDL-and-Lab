...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(CLK, SCLR, A, B, P)
/* synthesis syn_black_box black_box_pad_pin="CLK,SCLR,A[7:0],B[7:0],P[15:0]" */;
  input CLK;
  input SCLR;
  input [7:0]A;
  input [7:0]B;
